...
│   ├── dev/                # Engineering principles, frontend, OCR, CodePen
...
| [`dev`](plugins/dev/) | [AGENTS.md](plugins/dev/AGENTS.md) | Engineering principles, frontend design, OCR text extraction, CodePen, browser logs, Playwright and provider CLIs |
| [`chats`](plugins/chats/) | [AGENTS.md](plugins/chats/AGENTS.md) | WhatsApp messaging, WeChat local search |
| [`google`](plugins/google/) | [AGENTS.md](plugins/google/AGENTS.md) | Google Workspace CLI wrapper for Gmail and Drive |
