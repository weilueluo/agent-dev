...
Follow `dev:principles`. Key for ambiguity detection:
- Push requirements toward typed contracts and schemas, not prose descriptions (Clear Boundary).
- Flag requirements that aren't mechanically testable (Test-Centric).
